...
import com.dataplume.HarVis.auth.payload.request.LoginRequest;
import com.dataplume.HarVis.auth.payload.request.SignupRequest;
import com.dataplume.HarVis.auth.payload.response.JwtResponse;
import com.dataplume.HarVis.auth.payload.response.MessageResponse;
import com.dataplume.HarVis.auth.repository.RoleRepository;
import com.dataplume.HarVis.auth.repository.UserRepository;
import com.dataplume.HarVis.auth.security.jwt.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Set<Role> roles = roleService.getRolesFromStrings(strRoles);
